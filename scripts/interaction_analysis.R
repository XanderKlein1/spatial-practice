...
#Generate a heatmap of the matrix to visualize cluster interactions:
raw_interaction <- pheatmap(
  interaction_mtx_norm,
  cluster_rows = FALSE,
  cluster_cols = FALSE,
  main = "Raw cluster interaction heatmap",
  color = colorRampPalette(c("white", "red"))(100)
)

ggsave(filename = "raw_interaction.pdf",
       plot = raw_interaction,
       width = 7,
       height = 5,
       dpi = 300)
